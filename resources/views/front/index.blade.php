            ...
            <div class="col-sm-12 col-md-12 col-lg-6 pb-30">
                <div class="quick-item bg-main">
                    ...
                    <div class="quick-item-text">
                        ...
                        <a href="#" class="btn btn-white btn-small">Order Now <i
                                class="flaticon-shopping-cart-black-shape"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-lg-6 pb-30">
...
<section class="team-section p-tb-100 bg-overlay-3 bg-off-white">
    <div class="container">
        <div class="section-title section-title-default">
            <small>Chefs</small>
            <h2>Who Made This Delicious Food</h2>
        </div>
        <div class="team-carousel owl-carousel owl-theme">
            <div class="item">
                <div class="team-item">
                    ...
                    <div class="team-content">
                        <h3 class="carousel-name"><a href="team-details.html">Anthony Rasel</a></h3>
            ...
            <div class="item">
                <div class="team-item">
                    ...
                    <div class="team-content">
                        <h3 class="carousel-name"><a href="team-details.html">Julia Margareta</a></h3>
            ...
            <div class="item">
                <div class="team-item">
                    ...
                    <div class="team-content">
                        <h3 class="carousel-name"><a href="team-details.html">Victor James</a></h3>
            ...
            <div class="item">
                <div class="team-item">
                    ...
                    <div class="team-content">
                        <h3 class="carousel-name"><a href="team-details.html">Angela Carter</a></h3>
...
<section class="blog-section p-tb-100 bg-wood-shape">
    <div class="container position-relative">
        <div class="section-title section-title-default">
            <small>Blog</small>
            <h2>Read Our Latest Food News</h2>
        </div>
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4 pb-30 wow animate__slideInUp" data-wow-duration="1s"
                ...
                <div class="blog-card blog-card-two">
                    ...
                    <div class="blog-card-content">
                        ...
                        <p>This Mexican Style Burger is pumped out with flavor from chilli powder</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-4 pb-30 wow animate__slideInUp" data-wow-duration="1s"
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 pb-30 offset-md-3 offset-lg-0 wow animate__slideInUp"
                ...
                <div class="blog-card blog-card-two">
                    ...
                    <div class="blog-card-content">
                        ...
                        <h3><a href="blog-details.html">What Is The Most Hived Pizza Among The Teenagers?</a></h3>
                        <p>This Mexican Style Burger is pumped out with flavor</p>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center">
            <a href="blogs-grid-without-sidebar.html" class="btn">Explore Blog <i
            ...
            <div class="subscribe-item">
                <div class="subscribe-form">
                    <form class="newsletter-form newsletter-form-white" data-bs-toggle="validator">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="email" id="emails" class="form-control" placeholder="Enter Email Address*"
